...
public class Member {
    ...
    //===========================================================================
        ...
        // 멤버 정보, 예) 강신우, 1234, ksw@naver.com, 2025-06-12 10시10분
        public String toCSV() {
        ...
        // 매개변수의 정보 : 타입 문자열
        // 내용 : 아래의 예) 의 형태입니다.
        // 한줄의 멤버의 정보를 : 예) 강신우, 1234, ksw@naver.com, 2025-06-12 10시10분
        // Member 인스턴스를 생성하는 재료로 사용할 예정
        // 매개변수가 4개인 인스턴스 생성하는 기능
        public static Member fromCSV(String csvLine) {
            // 시뮬레이션1
            // String csvLine = "강신우, 1234, ksw@naver.com, 2025-06-12 10시10분"
            String[] parts = csvLine.split(",",-1); // -1 , 없는 데이터 있어도, 그 자리 형태를 유지, 정보 4개형태
            // 시뮬레이션2
            // parts = {"강신우", "1234", "ksw@naver.com", "2025-06-12 10시10분"}
            if(parts.length != 4) {
                return null;
            }
