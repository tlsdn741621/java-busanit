...
public class ShapeEx1 {
    ...
    // 다음 설계시 주의점
    // 추상클래스
    // 1) 내가 만든 기능은 이름만 정의를 하고, 기능을 구형을 안해야지 왜?, 어차피 내꺼 안쓰고, 각자
    // 알아서 재정의해서 사용하니
    // 2) 인터페이스
    ...
    // 그럼 다양한 기능을 추가 하고 싶을때, 하나의 클래스에서 파일의 내용이 길어짐
    // 그래서, 그럼 어떻게 다양한 기능을 추가하고, 재사용, 객체지향적으로 접근할까?
    ...
    // 생성자 오버로딩 -> 메소드 오버로딩
    // 오버로딩 -? 저그 이야기 -> 짐을 더 추가
    // 여기서 의미는 , 생성자의 모양은 똑같지만, 매개변수의 모양, 갯수가 다른것
    // 생성자 만들지 여부
    ...
    // 서버 사이드 렌더링 작업중 웹 1차 작업 위한 개별 학습중
